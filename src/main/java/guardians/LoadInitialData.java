...
public class LoadInitialData {
	...
	@Autowired
	ShiftConfigurationRepository shiftConfRepository;
	@Autowired
	...
	private void preloadDoctor(int number, LocalDate startDate, int minShifts, int maxShifts, int numConsultations,
		...
		preloadDoctor(number + "", number + "", number + "@guardians.com", startDate, minShifts, maxShifts, numConsultations,
			doesCycleShifts, hasShiftsOnlyWhenCycleShifts);
	}
}
